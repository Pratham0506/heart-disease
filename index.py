...
# Load dataset
df_heart = pd.read_csv("./heart_disease_dataset (1).csv")
...
scaler = MinMaxScaler()
df_heart[features_to_normalize] = scaler.fit_transform(df_heart[features_to_normalize])
...
X = df_heart.drop(columns=['HeartDisease'])  # Features
